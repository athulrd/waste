...
<form method="post" action="<?php echo site_url('Menudata/add_newmember'); ?>">
        ...
        <div class="box-body">
           <div class="form-group">
              <div class="row">
                ...
                <div class="col-xs-5">
                    <input class="form-control" type="text" name='name' id='name' placeholder="Enter Member Name">     
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-xs-5">
                    <input class="form-control" type="text" name='number' id='number' placeholder="Enter Mobile Number">     
                </div>
              </div>
            </div>
