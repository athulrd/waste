  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <form class="form-horizontal" id="addbinform" name="addbinform">
        <div class="box-body">
         <div class="form-group">
              <div class="row">
                 <label for="inputEmail3" class="col-sm-2 control-label">Enter Bin Number</label>
                <div class="col-xs-5">
                    <input class="form-control" type="text" id='binno' name='binno' placeholder="Enter Bin Number">     
                </div>
              </div>
          </div>
          <div class="form-group">
...
$('.add_btn').click(function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url(); ?>/Menudata/addbin",
                    data: $('#addbinform').serialize(),
                    dataType: "json",
